...
export class AnkrSolanaProvider extends ProviderBase {
    ...
    constructor(providerConfig: providerConfig, ankrConfig: AnkrConfig) {
        ...
        this.url = `${this.ankrConfig.ANKR_BASE_URL}/${ANKR_PROVIDER_ENDPOINTS.SOLANA}/${this.ankrConfig.ANKR_API_KEY}`;
    }
